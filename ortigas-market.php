...
<div class="main-header-wrapper">
		...
		<div class="header">
					...
					<a href=#"><img height="130" width="950" alt="Bordeaux" src="images/seaside-cover-edited.gif"></a>					
					<!-- END .logo -->
					</div>
					...
					<table>
						<tbody><tr>
							<td class="menu">
                                ...
                                <li><a href=""><i>Wet Market Prices</i></a>
                                <ul class="sub-menu">
	<li><a href="alabang-market.php">Alabang</a></li>
	<!--<li><a href="ortigas-market.php">Ortigas</a></li>    
	<li><a href="macapagal-market.php">Macapagal</a></li>-->    	
</ul>
                                </li>							<li><a href="">Promos</a><ul class="sub-menu">
	<li><a href="alabang-promo.html">Alabang</a></li>
	<li><a href="ortigas-promo.html">Ortigas</a></li>    
	<li><a href="macapagal-promo.html">Macapagal</a></li>    	
</ul></li>
            ...
            <div class="top-navigation-wrapper">
				<div class="top-navigation container-nav">
					<div class="top-navigation-left"><img alt="telephone" style="margin-right: 8px;" src="images/phone.png">Make your Reservation or Booking : Mobile: 0920-9704481 / 0917-8271450 </div>					
										...
										<div activepage="2" id="card-container">
											...
											<div id="card-slider" class="content" style="display: block;">
																...
																<div id="cardpageid-2" class="card-page">
																	...
																	<div class="menu-card-title">Ortigas - Wet Market Prices</div>
<h4>Updated Daily</h4>
...
<table class="item">
																		<tbody><tr>
																			...
																			<td class="text">
																				...
																				<p class="title"><?php echo $row['item_desc'] ?></p>
																				<p class="description">&nbsp;</p>
																			</td>
																			<td class="menu-price"><p><?php echo $row['item_price'] ?></p></td>
																		</tr>
																	</tbody></table>
<?php
//execute the SQL query and return a specific record
...
?>
        ...
        jQuery(document).ready(function($){
			...
			<div class="tweet active"><ul class="tweet_list">
			  <a href="seasidemanila@gmail.com">seasidemanila@gmail.com</a>
			</ul></div>
		...
		<div class="sidepanel">
		  ...
		  <h3 class="font">We are OPEN almost 24 hours a day</h3>			<div class="textwidget">
